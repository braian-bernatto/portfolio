...
const rawProjects: {
...
}[] = [
  {
    ...
    highlights: [
      ...
      L('Technical Leadership — Kept the codebase self-documenting through living in-repo documentation — a curated README paired with auto-generated TSDoc component reference — streamlining the development lifecycle and drastically reducing the onboarding time for new developers.', 'Liderazgo Técnico — Mantuve el codebase autodocumentado mediante documentación viva en el repo — un README curado junto con una referencia de componentes auto-generada con TSDoc — agilizando el ciclo de desarrollo y reduciendo drásticamente el tiempo de onboarding para nuevos desarrolladores.'),
    ],
    stack: ['React.js', 'TypeScript', 'shadcn/ui', 'TailwindCSS', 'Zustand', 'TanStack Query', 'Zod + RHF', 'Storybook', 'Vitest'],
    featured: true,
    placeholder: 'banking',
