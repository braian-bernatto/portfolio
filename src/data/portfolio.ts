...
}[] = [
  {
    ...
    highlights: [
      ...
      },
      {
        ...
        body: L(
          'Defined and enforced engineering standards through a "Docs as Code" approach, streamlining the development lifecycle and drastically reducing the onboarding time for new developers.',
          'Definí e impuse estándares de ingeniería mediante un enfoque "Docs as Code", agilizando el ciclo de desarrollo y reduciendo drásticamente el tiempo de onboarding para nuevos desarrolladores.'
        ),
      },
    ],
